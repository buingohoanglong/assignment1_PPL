...
class LexerSuite(unittest.TestCase):
    ...
    def test_invalid_string_literal_3(self):
        self.assertTrue(TestLexer.checkLexeme(""" "abc'xyz" """, """abc  xyz,<EOF>""",88)) # ???  

    def test_invalid_string_literal_4(self):
        self.assertTrue(TestLexer.checkLexeme(""" "abc\'xyz" """, """abc  xyz,<EOF>""",89))  # ??? 
    ...
    def test_invalid_array_literal_2(self):
        self.assertTrue(TestLexer.checkLexeme("{{1, 2}, {4, 5, {3, 5}}", "{1,2,3,4,5},<EOF>",100)) # ???    
